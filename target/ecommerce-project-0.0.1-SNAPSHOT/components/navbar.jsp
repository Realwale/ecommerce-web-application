...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>OlaStore</i></h3></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              Welcome to OlaStore, the online shopping destination where you can find everything you need!
              We are a team of passionate individuals who love to shop and provide our customers with the best experience possible.
              At OlaStore, we believe that shopping should be simple, easy and fun.
              That's why we've made it our mission to offer you the widest range of products at the most competitive prices.
              From trendy fashion items to high-tech gadgets, we've got you covered.<br><br> We know that shopping online can be daunting,
              which is why we're dedicated to providing you with excellent customer service.
              Our friendly and knowledgeable team is always on hand to help you with any questions or concerns you may have.<br><br> So why not shop with us today and experience the convenience of OlaStore?
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phone.png" style="width:27px;" alt="img">+2347039559296<br>
                <img src="images/mail.png" style="width:29px;" alt="img">hellowaleagboola@gmail.com
            </b>
        </p>
        </div>
      </div>
